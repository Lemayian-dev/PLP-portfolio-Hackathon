...
const Hero: React.FC = () => {
    ...
    return (
        <section id="home" className="hero-section min-h-screen flex items-center justify-center bg-[#101625] relative overflow-hidden">
            {/* Animated Background */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                <div className="max-w-4xl mx-auto">
                    {/* Profile Image */}
                    <div className="w-48 h-48 md:w-56 md:h-56 mx-auto mb-6 md:mb-8 rounded-full overflow-hidden border-4 border-white shadow-2xl">
                        <img
                            src="/Portrait1.jpg"
                    ...
                    <h1 className="section-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-6 hero-title">
                        <span className="block text-lg sm:text-xl md:text-2xl mb-2 text-gray-300">Hi there 👋🏼</span>
                    ...
                    <p className="section-text text-lg sm:text-xl md:text-2xl text-gray-200 mb-6 md:mb-8 max-w-3xl mx-auto leading-relaxed hero-description">
                        I'm a <span className="text-blue-400 font-semibold">designer</span> and <span className="text-purple-400 font-semibold">developer</span> who loves creating cool stuff! 🚀
                    </p>

                    {/* Description */}
                    <p className="section-text text-base sm:text-lg text-gray-300 mb-8 md:mb-12 max-w-2xl mx-auto px-4">
                        I build websites and apps that actually look good and work great. With 4+ years of turning coffee into code and 110+ projects under my belt, I'm all about making digital experiences that people actually enjoy using.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center hero-buttons px-4">
                        <Button
                            ...
                            onClick={() => window.open('/Isaac Lemayian CV (2).pdf', '_blank')}
                        >
                    ...
                    <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 mt-8 md:mt-12 hero-stats px-4">
                        <div className="text-center">
                            <div className="text-2xl sm:text-3xl font-bold text-blue-400">110+</div>
                    ...
                    <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2">
                        <button
                            onClick={scrollToNext}
                            className="group p-2 sm:p-3 rounded-full bg-blue-600/80 backdrop-blur-sm text-white shadow-lg hover:bg-blue-700 hover:scale-110 transition-all duration-300 animate-bounce"
