...
const Projects: React.FC = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            technologies: ['PHP', 'SQL', 'FluentCRM', 'WooCommerce', 'Stripe', 'M-pesa'],
    ...
    return (
        <section id="projects" className="projects-section py-20 bg-[#101625]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div key={project.id} className="bg-gray-800/50 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-700">
                            ...
                            <div className="p-4 md:p-6 lg:p-8">
                                ...
                                <div className="flex justify-center">
                                    <Button asChild className="w-full sm:w-auto text-sm md:text-base">
                ...
                {/* Other Projects */}
                <div className="px-4">
                    <h3 className="section-title text-2xl sm:text-3xl font-bold text-white text-center mb-8 md:mb-12">Other Projects</h3>
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        {otherProjects.map((project) => (
                            <div key={project.id} className="bg-gray-800/50 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 border border-gray-700">
                                ...
                                <div className="p-4 md:p-6">
                                    <h4 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3">{project.title}</h4>
                                    <p className="text-gray-300 mb-3 md:mb-4 text-xs md:text-sm leading-relaxed line-clamp-3">{project.description}</p>
